//#include "XMLParser.h"
//
//void XMLParser::add(const std::string& category, const std::string& key, boost::any value){
...
//	_categories.insert( std::pair<std::string, InHomoContainer>(category, InhomogenousContainer()));
//
//	//Reference to the category's container and add the particular value with its key
//	_categories[category].add(key, value);
//}
//
//void XMLParser::add(const std::string& category, const std::string& key, const char* value){
//    add(category, key, std::string(value));
//}
//
//void XMLParser::change(const std::string& category, const std::string& key, boost::any newValue){
...
//}
//
//void XMLParser::change(const std::string& category, const std::string& key, const char* newValue){
//	if(_categories.count(category) != 0){
...
//}
//
//void XMLParser::writeToXML(const std::string& outputFile){
...
//		xercesc::DOMImplementation*	impl			= xercesc::DOMImplementationRegistry::getDOMImplementation(NULL);
//		xercesc::DOMLSSerializer*	theSerializer	= ((xercesc::DOMImplementationLS*)impl)->createLSSerializer();
//
//		//Enables the pretty-print feature, so that the created xml file is well formatted and thus easy to read.
//		theSerializer->getDomConfig()->setParameter(xercesc::XMLUni::fgDOMWRTFormatPrettyPrint, true);
//
//		//Checks whether the user passed a new output path.
...
//}
//
//void XMLParser::loadXML(const std::string& inputFile){
//
