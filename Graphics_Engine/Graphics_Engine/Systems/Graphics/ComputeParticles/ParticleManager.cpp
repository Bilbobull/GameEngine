...
namespace ComputeParticles
{
  void ParticleManager::loadParticleBuffer(int numParticles, int iniRadius){
    ...
    ComputeParticle* _particles = new ComputeParticle[_numParticles];
    ...
    glBufferData(GL_SHADER_STORAGE_BUFFER, numParticles*sizeof(ComputeParticle), _particles, GL_STATIC_DRAW);
  ...
  void ParticleManager::setParticles(ComputeParticle* particles, int numParticles, int iniRadius){
