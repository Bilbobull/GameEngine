...
{
  std::string	ComputeShaderManager::getFileContents(const std::string& filename) const{
  ...
  void ComputeShaderManager::loadShader(const std::string& filename, const std::string& shaderKey, const GLenum type){
  ...
  void ComputeShaderManager::attachShader(const std::string& shaderKey, const std::string& shaderProgramKey){
    glGetError();
  ...
  void ComputeShaderManager::detachShader(const std::string& shaderKey, const std::string& shaderProgramKey){
    glGetError();
  ...
  void ComputeShaderManager::resetProgram(){
    glUseProgram(0);
  }

  void ComputeShaderManager::createProgram(const std::string& shaderProgramKey){
  ...
  void ComputeShaderManager::useProgram(const std::string& shaderProgramKey){
    glGetError();
  ...
  void ComputeShaderManager::linkProgram(const std::string& shaderProgramKey){
    glGetError();
  ...
  GLuint ComputeShaderManager::getShaderID(const std::string& shaderKey){
    return _shaderData.getShaderID(shaderKey);
  }

  GLuint ComputeShaderManager::getShaderProgramID(const std::string& shaderProgramKey){
    return _shaderData.getShaderProgramID(shaderProgramKey);
  }

  void ComputeShaderManager::deleteProgram(const std::string& shaderProgramKey){
    glGetError();
  ...
  void ComputeShaderManager::deleteShader(const std::string& shaderKey){
    glGetError();
  ...
  ComputeShaderManager* ComputeShaderManager::_instance = NULL;

  ComputeShaderManager* ComputeShaderManager::getInstance(){
    if (_instance == NULL){
      _instance = new ComputeShaderManager();
    }

    return _instance;
  }

  void ComputeShaderManager::loadUintUniform(const std::string& shaderProgram, const std::string& name, const GLuint value){
    glGetError();
  ...
  void ComputeShaderManager::loadFloatUniform(const std::string& shaderProgram, const std::string& name, const GLfloat value){
    glGetError();
  ...
  void ComputeShaderManager::loadVec4Uniform(const std::string& shaderProgram, const std::string& name, const GLfloat x, const GLfloat y, const GLfloat z, const GLfloat w){
    glGetError();
    int _uniID = glGetUniformLocation(getShaderProgramID(shaderProgram), name.c_str());
  ...
  void ComputeShaderManager::loadMatrix4Uniform(const std::string& shaderProgram, const std::string& name, const GLfloat* value){
    glGetError();
    int _uniID = glGetUniformLocation(getShaderProgramID(shaderProgram), name.c_str());
  ...
  void ComputeShaderManager::getBufferVariableIndices(const std::string& shaderProgram, const int length, const GLchar** names, GLint* indices){
